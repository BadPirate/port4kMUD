module.exports = {
  ...
  rules: {
    ...
    'no-console': 'warn', // Downgrade console statements from error to warning
    'react-hooks/exhaustive-deps': 'warn', // Downgrade dependency array issues from error to warning
    'prettier/prettier': 'warn', // Downgrade prettier issues from error to warning
  },
  overrides: [
    {
      files: ['**/*.ts', '**/*.tsx'],
